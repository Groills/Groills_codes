            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="flex-1">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                      <h1 className="text-3xl md:text-4xl font-bold text-white bg-clip-text text-transparent animate-gradient">
                        @{owner?.username}
                      </h1>
                  ...
                  <p className="mt-4 text-gray-300 max-w-lg text-lg leading-relaxed">
                    Proud member of Groills 🚀 | Sharing skill-building videos
                    to help us all grow | Zero distractions, just pure progress
                    | Let’s learn and achieve together!
                  </p>
                  ...
                  <div className="mt-6 flex space-x-4">
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-purple-700 rounded-lg" />
                      <div className="px-5 py-1  bg-black rounded-[6px]  relative group transition duration-200 text-white hover:bg-transparent">
                        Start Meeting
                      </div>
                    </button>
                  </div>
            ...
            >
              {videos.map((video) => (
                <motion.div
                  key={video._id}
                  whileHover={{ y: -5 }}
                  className="bg-muted/40 rounded sm:rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow mx-4 sm:ml-5 p-3 sm:p-4 mt-3 sm:mt-5"
                >
                  {/* 🔄 Responsive layout: row on mobile, column on sm+ */}
